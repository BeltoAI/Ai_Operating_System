...
object AgentClient {
    ...
    fun ask(
        ...
        val system = buildString {
            ...
            append("types: open_app, web_search, dial, sms, send_sms, message, camera, settings, add_event, timer, alarm, compose_post, spicy_post, write_paper, pin_app, checklist_add, none. ")
