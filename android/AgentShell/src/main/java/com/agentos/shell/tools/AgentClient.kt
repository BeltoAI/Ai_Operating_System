...
object AgentClient {
    ...
    fun ask(
        ...
        val system = buildString {
            ...
            append("share_location={\"name\":\"Mom\",\"channel\":\"sms\",\"home\":\"<optional address>\",\"navigate\":true} — for 'share my live location with X (until I get home)'. It texts the person a fresh Maps link on an interval and stops when you reach home. Set 'navigate':true ONLY when the user also asks to be taken/navigated home (e.g. 'navigate me home', 'until I get home'); otherwise omit it so it just shares WITHOUT opening Maps. channel is sms|telegram (default sms); 'home' defaults to the user's saved address. Do NOT use 'navigate' for a plain 'share my location' request. Add share_location to the action types. ")
