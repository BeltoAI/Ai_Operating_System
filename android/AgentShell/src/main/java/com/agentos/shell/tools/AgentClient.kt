...
object AgentClient {
    ...
    fun ask(
        ...
        val system = buildString {
            ...
            append("share_location={\"name\":\"Mom\",\"channel\":\"sms\",\"home\":\"<optional address>\"} — for 'share my live location with X until I get home / and navigate me home'. It texts the person a fresh Maps link on an interval and stops when you reach home, and opens navigation home. channel is sms|telegram (default sms); 'home' defaults to the user's saved address. Add share_location to the action types. ")
